...
class MemberAdmin(VersionAdmin):
    ...
    list_filter = ('last_paid_date', 'ca_member', IsStillMember, IsLateOnVpn, 'vpn', 'cube', 'is_not_a_member_yet')
    ...
    fieldsets = (
        ...
        ('Abonnements', {
            'fields': (('vpn', 'cube'), ('vpn_is_paid_until', 'vpn_fee_rate'), ('domain_names_we_handle',)),
        }),
