...
class OrderAdmin(VersionAdmin):
    ...
    list_display = (
        ...
        "domain_name",
        "member_has_been_give_order",
        "has_a_working_cube_or_dont_care",
        "group_order_number",
    )
    list_filter = ("has_payed", "member_has_been_give_order", "group_order")
    fieldsets = (
        (None, {"fields": (("made_on", "group_order"),)}),
        ("Member infos", {"fields": (("nick", "email"), ("first_name", "last_name"))}),
        (
            "Member preferences",
        ...
        (
            "Status informations",
            {
                "fields": (
                    ...
                    ("has_payed", "price_payed"),
                    ("member_has_been_give_order", "we_have_received_the_order"),
                    ("has_a_working_cube",),
                )
            },
        ),
